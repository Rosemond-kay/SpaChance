...
export default function Navbar({ activePage, setActivePage, onOpenBookModal, onOpenGiftModal }) {
      ...
      {mobileMenuOpen && (
        ...
        >
          <img
            src="/assets/spachance_logo.png"
            alt="SpaChance"
            style={{ height: '110px', width: 'auto', marginBottom: '1rem', objectFit: 'contain' }}
          />
          ...
          {navItems.map((item) => (
            <button
              ...
              style={{
                ...
                color: activePage === item.id ? 'var(--accent-dark)' : 'var(--text-primary)',
                fontWeight: activePage === item.id ? 600 : 500,
                cursor: 'pointer'
              }}
            >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.9rem', width: '80%', maxWidth: '280px', marginTop: '1rem' }}>
            <a
              href={BRAND.freshaBookingUrl}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <button onClick={onOpenGiftModal} className="btn-secondary" style={{ width: '100%' }}>
              <Sparkles size={16} />
              Purchase Gift Card
            </button>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', fontSize: '0.88rem', color: 'var(--accent-dark)', marginTop: '0.4rem' }}
            >
              <Phone size={15} />
